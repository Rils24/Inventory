...
switch ($filterType) {
    case 'tanggal':
        $filterTanggal = "WHERE Tanggal_keluar = '$filterValue'";
        break;
    case 'bulan':
        $filterTanggal = "WHERE DATE_FORMAT(Tanggal_keluar, '%Y-%m') = '$filterValue'";
        break;
    case 'tahun':
        $filterTanggal = "WHERE YEAR(Tanggal_keluar) = '$filterValue'";
        break;
    default:
        $filterTanggal = '';
        break;
...
// Ambil data keluar sesuai dengan filter
$queryDataKeluar = "SELECT * FROM keluar $filterTanggal";
